...
| `maintenance` | 2026-09-18 | Own the defects no open workstream covers, on `main` and on maintained release lines, and drive maintenance releases | paused 2026-09-20; recursive E2E passed; whole-configuration coverage and actual host upgrade acceptance remain | `ws-maintenance/triage`; `ws-maintenance/outbox` | [workstream status](engineering-docs/wip/2026-09-18-maintenance/CURRENT-STATUS.md) |
