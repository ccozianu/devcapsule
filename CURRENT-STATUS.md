...
| `maintenance` | 2026-09-18 | Own the defects no open workstream covers, on `main` and on maintained release lines, and drive maintenance releases | paused 2026-09-20; graphical 0.2.14.dev0 successor running on 0.2.12-generated test config; independent inspection passed; GUI acceptance pending | `ws-maintenance/triage`; `ws-maintenance/outbox` | [workstream status](engineering-docs/wip/2026-09-18-maintenance/CURRENT-STATUS.md) |
