...
| `maintenance` | 2026-09-18 | Own the defects no open workstream covers, on `main` and on maintained release lines, and drive maintenance releases | active 2026-09-22; run-image replacement validated and ready for owner PR integration; broader triage preserved | `ws-maintenance/triage` | [workstream status](engineering-docs/wip/2026-09-18-maintenance/CURRENT-STATUS.md) |
