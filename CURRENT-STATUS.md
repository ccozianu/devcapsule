...
| `maintenance` | 2026-09-18 | Own the defects no open workstream covers, on `main` and on maintained release lines, and drive maintenance releases | active; releasing 0.2.14; RC0 published; runtime CLI repair implemented; release blocked pending candidate acceptance | `release-0.2.14` | [workstream status](engineering-docs/wip/2026-09-18-maintenance/CURRENT-STATUS.md) |
...
| `user-docs` | 2026-09-12 | Deliver V1 adopter documentation from first useful session through resuming work | paused 2026-09-22; website content contract delivered as R-DOCS-003 and handed to the website project; resumes with UD-001 on the owner's return | `ws-user-docs/first-session` | [workstream status](engineering-docs/wip/2026-09-12-user-docs/CURRENT-STATUS.md) |
