...
| `maintenance` | 2026-09-18 | Own the defects no open workstream covers, on `main` and on maintained release lines, and drive maintenance releases | paused 2026-09-20; configuration contract refactor complete; all nine audit gap families fixed; gate 877 tests plus nine packaged tests; owner PR/host acceptance next; 14 open bugs | `ws-maintenance/triage`; `ws-maintenance/outbox` | [workstream status](engineering-docs/wip/2026-09-18-maintenance/CURRENT-STATUS.md) |
