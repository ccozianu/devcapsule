...
| `project-management` | 2026-08-09 | Maintain project-wide priorities, sequencing, dependencies, and lifecycle coordination | active 2026-09-22; owner release-fix propagation rule recorded; runbook aligned; awaiting owner PR integration; 0.2.14 cut awaits readiness decisions | `project-management/coordination` | [workstream status](engineering-docs/wip/2026-08-09-project-management/CURRENT-STATUS.md) |
