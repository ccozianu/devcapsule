...
| `website` | 2026-09-16 | Deliver the website autonomy experiment: repository-owned landing/docs/blog content, independently developable website submodule, local preview and publishing mechanism | active 2026-09-19; experiment accepted successful, A−; owner-requested follow-up inventory recorded, implementation pending prioritization | `website/initial-cut`; explicit preparation exception in handoff | [workstream status](engineering-docs/wip/2026-09-16-website/CURRENT-STATUS.md) |
