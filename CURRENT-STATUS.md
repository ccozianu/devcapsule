...
| `website` | 2026-09-16 | Deliver the website autonomy experiment: repository-owned landing/docs/blog content, independently developable website submodule, local preview and publishing mechanism | paused 2026-09-18 for owner-selected project-management; site delivered and public; experiment verdict and closure pending | `website/initial-cut`; explicit preparation exception in handoff | [workstream status](engineering-docs/wip/2026-09-16-website/CURRENT-STATUS.md) |
