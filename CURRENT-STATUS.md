...
| `maintenance` | 2026-09-18 | Own the defects no open workstream covers, on `main` and on maintained release lines, and drive maintenance releases | paused 2026-09-22; run-image replacement integrated in PR #125; attribution fix validated, awaiting owner UI acceptance and PR integration | `ws-maintenance/triage` | [workstream status](engineering-docs/wip/2026-09-18-maintenance/CURRENT-STATUS.md) |
