...
| `user-docs` | 2026-09-12 | Deliver V1 adopter documentation from first useful session through resuming work | active 2026-09-15; first-adopter journey from landing page through first useful session and resume | `user-docs/first-session`; `user-docs/outbox` | [workstream status](engineering-docs/wip/2026-09-12-user-docs/CURRENT-STATUS.md) |
