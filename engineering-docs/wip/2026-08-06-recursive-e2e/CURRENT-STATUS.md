...
sessions and the stale-lock fix (`054df4e`):

1. **Prepare v027, the replacement for v026.1.** Not a patch release: it
...
2. **Remediate `project_configuration.py` to the Hoare standard —
   immediately after v027 preparation.** From the 2026-08-23 diagnosis:
