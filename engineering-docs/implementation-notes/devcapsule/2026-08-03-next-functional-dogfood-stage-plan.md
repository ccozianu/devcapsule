...
`engineering-docs/bugs/devcapsule/2026-08-03-authorized-development-sudo-misreported.md`.
...
The obsolete `devcapsule-src/tests/manual/v1-second-checkout-dogfood.sh` is removed.
...
On 2026-08-05, `cd devcapsule-src && .venv/bin/python -m nox -s tests` passed all
