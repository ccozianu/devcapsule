...
Updated: 2026-09-24. Stage: **RC4 public, verified, local proofs passed; owner testing pending**.
...
| [v0.2.14-rc4](https://github.com/ccozianu/devcapsule/releases/tag/v0.2.14-rc4) | `abb785d7ad4069606fd3ab84009ca8efeabc22b9` | Tagged 2026-09-24 after PR #140; gate passed with zero missing commits. Public PEX, checksum and manifest verified 2026-09-24; local proofs passed against the download. | Owner testing pending: `config list` as data with SOURCE, `config show` with Sources and a truthful review on both host checkouts. |
