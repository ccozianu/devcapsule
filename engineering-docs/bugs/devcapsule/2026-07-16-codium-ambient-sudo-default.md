...
the unconditional sudo rule in the former Codium-specific entrypoint. The referenced command and its dedicated launcher/assets have been
...
Historical status note (superseded by retirement): open; diagnosed and evidenced, no fix implemented
