...
related:
  - engineering-docs/decisions/product/d-0004-configuration-resolution-and-guided-run.md
  - engineering-docs/design-notes/devcapsule/v1-user-experience.md
  - devcapsule-src/tests/manual/v1-second-checkout-dogfood.sh
...
The existing design draft at `engineering-docs/design-notes/devcapsule/v1-user-experience.md` was
...
`devcapsule-src/tests/manual/v1-second-checkout-dogfood.sh`. It specifies:
...
- `devcapsule-src/devcapsule/commands/images.py` for the new command group;
- `devcapsule-src/devcapsule/image_metadata.py` for labels, local inventory,
...
- current interface documentation in `devcapsule-src/README.md`.
...
`engineering-docs/implementation-notes/devcapsule/2026-08-01-nvidia-cuda-base-recipe-validation.md`.
